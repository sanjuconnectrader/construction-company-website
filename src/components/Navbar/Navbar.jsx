            ...
            <div className="navbar__links">
              ...
              >
                ...
                >
                  Services
                  <svg
                    className={`navbar__dropdown-icon ${dropdownOpen ? "navbar__dropdown-icon--open" : ""}`}
                    width="16"
                    height="16"
                    viewBox="0 0 24 24"
                    fill="none"
                ...
                >
                  <li>
                    <Link to="/excavation" className="navbar__dropdown-item" role="menuitem" onClick={closeAllMenus}>
                      ...
                      <div className="dropdown-item__content">
                        <span className="dropdown-item__title">Excavation</span>
                        <span className="dropdown-item__desc">Precision digging & site prep</span>
                      </div>
                    </Link>
                  </li>
                  <li>
                    <Link to="/construction" className="navbar__dropdown-item" role="menuitem" onClick={closeAllMenus}>
                      <div className="dropdown-item__icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <path d="M3 21H21M5 21V7M9 21V13M13 21V17M17 21V15" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                        </svg>
                      </div>
                      <div className="dropdown-item__content">
                        <span className="dropdown-item__title">Construction</span>
                        <span className="dropdown-item__desc">New building projects</span>
                      </div>
                    </Link>
                  </li>
                  <li>
                    <Link to="/renovation" className="navbar__dropdown-item" role="menuitem" onClick={closeAllMenus}>
                      <div className="dropdown-item__icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <path d="M7 21H3V17M17 21H21V17M3 7V3H7M17 3H21V7" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                        </svg>
                      </div>
                      <div className="dropdown-item__content">
                        <span className="dropdown-item__title">Renovation</span>
                        <span className="dropdown-item__desc">Transform existing spaces</span>
                      </div>
                    </Link>
                  </li>
                  <li>
                    <Link to="/demolition" className="navbar__dropdown-item" role="menuitem" onClick={closeAllMenus}>
                      <div className="dropdown-item__icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <path d="M19 7L12 14L5 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                        </svg>
                      </div>
                      <div className="dropdown-item__content">
                        <span className="dropdown-item__title">Demolition</span>
                        <span className="dropdown-item__desc">Safe structure removal</span>
                      </div>
                    </Link>
                  </li>
                </ul>
      ...
      >
        ...
        <nav className="navbar__mobile-nav">
          ...
          <div className="navbar__mobile-dropdown">
            <button 
              className="navbar__mobile-dropdown-button"
              onClick={handleDropdownToggle}
              aria-expanded={dropdownOpen}
            >
              <span>Services</span>
              <svg
                className={`navbar__mobile-dropdown-icon ${dropdownOpen ? "navbar__mobile-dropdown-icon--open" : ""}`}
                width="16"
                height="16"
                viewBox="0 0 24 24"
                fill="none"
            ...
            <div className={`navbar__mobile-dropdown-content ${dropdownOpen ? "navbar__mobile-dropdown-content--open" : ""}`}>
              <Link to="/excavation" className="navbar__mobile-dropdown-item" onClick={closeAllMenus}>
                <div className="mobile-dropdown-item__icon">
              ...
              <Link to="/construction" className="navbar__mobile-dropdown-item" onClick={closeAllMenus}>
                <div className="mobile-dropdown-item__icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path d="M3 21H21M5 21V7M9 21V13M13 21V17M17 21V15" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                  </svg>
              ...
              <Link to="/renovation" className="navbar__mobile-dropdown-item" onClick={closeAllMenus}>
                <div className="mobile-dropdown-item__icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path d="M7 21H3V17M17 21H21V17M3 7V3H7M17 3H21V7" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                  </svg>
              ...
              <Link to="/demolition" className="navbar__mobile-dropdown-item" onClick={closeAllMenus}>
                <div className="mobile-dropdown-item__icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path d="M19 7L12 14L5 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                  </svg>
